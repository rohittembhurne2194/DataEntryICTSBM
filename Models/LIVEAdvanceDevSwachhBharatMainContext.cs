    ...
    public class LIVEAdvanceDevSwachhBharatMainContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=103.241.147.9;Initial Catalog=LIVEAdvanceDevSwachhBharatMain;User Id=sa; Password=Bi9vAppy;Connection Timeout=3600;");
            }
        }
    }
}
